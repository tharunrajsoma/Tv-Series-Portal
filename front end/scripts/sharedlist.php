  ...
  <div id="container" style="display:block">
    <section class="clear">
      ...
      $user_id = $_SESSION['login_id'];
   		$sql = "SELECT SERIES_ID,series_name,year,rating FROM SERIES_INFO natural join FAVOURITES where user_id='$user_id' ";
   		...
   		while ($row = pg_fetch_assoc($result)) {
 			...
 			echo "<button class='buttons' id='$button2_id' type='submit' name='$button2_id'  value='$button1_id' onclick=\"hide('$button2_id');\">Remove as favourite</button>";
 			echo "</form>";
 	 		echo "</br>";
 	 		echo "</br>";
